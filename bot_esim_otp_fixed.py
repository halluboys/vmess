...
async def on_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "m:esim10":
        ...
        if not ok_limit:
            ...
            return
        await _dor_esim("162d261b-05c7-450c-9b7a-1873b160140c", "eSIM 10GB", 11)
        return
    ...
    if data == "m:esim10v2":
        ...
        if not ok_limit:
            ...
            return
        await _dor_esim("162d261b-05c7-450c-9b7a-1873b160140c", "eSIM 10GB v2", 12)
        return
...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == "wait_msisdn":
        ...
        try:
            otp_result = get_otp(str(number))
            print(f"OTP request result for {number}: {repr(otp_result)}")

            # Beberapa provider tetap mengirim SMS OTP walau tidak mengembalikan subscriber_id.
            # Untuk flow bot ini, OTP dianggap berhasil diminta selama tidak melempar exception.
            context.user_data["otp_subscriber_id"] = otp_result if otp_result else ""
