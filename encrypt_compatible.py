...
def ax_api_signature(
    ...
    # Kompatibel dengan helper lama (4 arg) maupun helper baru (5 arg).
    # Sebagian build crypto_helper sudah mengikat API key secara internal/env,
    # jadi pemanggilan 4 arg memang benar.
    try:
        return make_ax_api_signature(api_key, ts_for_sign, contact, code, contact_type)
    except TypeError:
