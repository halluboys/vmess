...
def settlement_qris(
    ...
    # ================================================================= #
    # ## BAGIAN YANG DIPERBAIKI (KEMBALI KE VERSI LAMA) ##
    # ================================================================= #
    # Memanggil fungsi signature dengan argumen yang lebih sederhana
    # Sesuai dengan file encrypt.py versi lama yang Anda miliki
    x_sig = get_x_signature_payment(
        api_key,
        tokens["access_token"],
        ts_to_sign,
        payment_target, # Menggunakan kode paket
        token_payment,  # Menggunakan token verifikasi pembayaran
        "QRIS"          # Menggunakan nama metode pembayaran
    )
    # ================================================================= #
