...
def settlement_qris(
    ...
    # ================================================================= #
    # Pertama, ubah dictionary payload menjadi string JSON
    payload_str = json.dumps(settlement_payload, separators=(',', ':'))

    # Sekarang, panggil fungsi signature dengan argumen yang benar
    x_sig = get_x_signature_payment(
        api_key=api_key,
        access_token=tokens["access_token"],
        ts_to_sign=ts_to_sign,
        payload=payload_str,
        payment_for=settlement_payload["payment_for"], # Mengambil dari payload
        path=path                                     # Mengambil dari variabel path di atas
    )
    # ================================================================= #
