...
async def on_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == "wait_msisdn":
        ...
        try:
            ...
            # Beberapa response OTP terbaru tetap mengirim SMS OTP tetapi tidak lagi
            # mengembalikan subscriber_id. Tetap lanjutkan flow login agar user tetap
            # bisa memasukkan OTP yang sudah diterima via SMS.
            if subscriber_id is None:
                print("OTP kemungkinan tetap terkirim walau subscriber_id tidak ada di response")
